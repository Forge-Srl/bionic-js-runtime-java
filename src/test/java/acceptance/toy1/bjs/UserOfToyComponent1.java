...
public class UserOfToyComponent1 extends BjsObject
{
    ...
    public static Long add(Long offset, Long int1, Long int2)
    {
        return bjs.getLong(bjs.call(bjsClass, "add", bjs.putPrimitive(offset), bjs.putPrimitive(int1),
                bjs.putPrimitive(int2)));
    }

    public static ToyComponent1BjsExport getToy(Long int1, Long int2)
    {
        return bjs.getWrapped(bjs.call(bjsClass, "getToy", bjs.putPrimitive(int1), bjs.putPrimitive(int2)));
    }

    public static Long getSum(ToyComponent1BjsExport toy1, ToyComponent1BjsExport toy2)
    {
        return bjs.getLong(bjs.call(bjsClass, "getSum", bjs.putWrapped(toy1, ToyComponent1BjsExport.Wrapper.class),
                bjs.putWrapped(toy2, ToyComponent1BjsExport.Wrapper.class)));
    }

    public static Long getSum2(ToyComponent2BjsExport toy1, ToyComponent1BjsExport toy2)
    {
        return bjs.getLong(bjs.call(bjsClass, "getSum2", bjs.putWrapped(toy1, ToyComponent2BjsExport.Wrapper.class),
                bjs.putWrapped(toy2, ToyComponent1BjsExport.Wrapper.class)));
    }
    ...
    public static Long additionalValue(ToyComponent2BjsExport toy)
    {
        return bjs.getLong(bjs.call(bjsClass, "additionalValue", bjs.putWrapped(toy, ToyComponent2BjsExport.Wrapper.class)));
    }
}
